// NewTask.jsx
// filepath: c:\Users\Hp\Videos\Employer_Management_System-master - Copy\src\components\TaskList\NewTask.jsx
import React from 'react';

const NewTask = ({ task, onReject }) => {
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow w-80">
      <div className="p-6">
        ...
        <div className="flex space-x-3">
          ...
          <button
            onClick={onReject}
            className="flex-1 bg-white hover:bg-gray-50 text-gray-800 px-4 py-2 rounded-lg border border-gray-300 text-sm font-medium transition-colors"
          >
            Reject
          </button>
        </div>
